...
if (isset($_POST['send'])) {
    ...
    $code = mt_rand(100000, 999999);
        $sql = $dbh->prepare("update   admin  set code=:code where AdminEmail=:email");
    ...
    $message = '<h1>Hi! Admin</h1><br><h3> We received a request to access your <i> Library System Admin Account</i>
